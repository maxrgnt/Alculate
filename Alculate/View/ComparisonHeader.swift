...
class ComparisonHeader: UIView {
    ...
    func constraints(anchorTo anchorView: UIView) {
        ...
        NSLayoutConstraint.activate([
            ...
            type.leadingAnchor.constraint(equalTo: anchorView.leadingAnchor, constant: UI.Sizing.Padding.comparisonHeader),
            ...
            add.trailingAnchor.constraint(equalTo: anchorView.trailingAnchor, constant: -UI.Sizing.Padding.comparisonHeader),
